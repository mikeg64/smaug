...
for i=0,n1-1 do b0z(i)=(par4((i-n1*1.d0/40.0),38.d0,0.6d0))^2.d0
for i=n1-2,0,-1 do b0z(i)=b0z(i)+b0z(i+1)


for i=0,n1-1 do bb(i)=par4((i-n1/5.8d0),40.d0,0.002d0)

;for i=0,n1-1 do bb1(i)=par4((i-n1/8.0d0),40.d0,0.003d0)

plot, bb, charsize=2.0

b0z=b0z/10.0d1+0.34e-3 ;-bb ;-bb1

b0z=b0z+100.d6/(z+100.d0*z[1])^2.0
...
xf=(par3(b0z(j)*x(i),1.3d5,0.5d0))^2.d0
