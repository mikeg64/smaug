...
for i=0,n1-1 do b0z(i)=par4((i-n1/10.0),40.d0,0.00054d0);)^2.d0
for i=n1-2,0,-1 do b0z(i)=b0z(i)+b0z(i+1)

;b0z=sqrt(0.021d0*(b0z/16.0d0+0.001d0))

;b0z(*)=sqrt(p(*,kk))/1.d3


b0z=b0z
b0z=4.d0^b0z-0.9999d0 ;-(1.d0-8.d2/(z+1.d0))
;plot, b0z, title='b0z', charsize=2.0


;b0z=10.0d0/(z/100.d0+1.d0)
...
close,11
;plot, harr, B0zarr, charsize=2.0
;************ read B0z end ***************

plot, b0zarr, title='b0z', charsize=2.0
oplot, b0zarr,psym=4

b0z = INTERPOL(B0zarr,n_elements(z))

!P.multi=0
plot, z/scale,b0z, title='b0z [Gauss]', charsize=1.8
oplot, harr, b0zarr, psym=5, color=200
stop
...
xf=(par3(b0z(j)*x(i),1.0d4,0.5d0))^2.d0
...
close,1
openw,1,'/data/ap1vf/2_6MmBlog.ini',/f77_unf
writeu,1,headline
...
contour, beta,z,x, LEVELS = [0.001,0.01,0.1,1.0, 10.0], $
