...
for i in range(80000,85000,1000):
    ...
    outfilename1=outfilepath+"nypnovmom1_ascii_"+str(i)+".vtk"
    outfilename2=outfilepath+"nypnovmom2_ascii_"+str(i)+".vtk"
    outfilename3=outfilepath+"nypnovmom3_ascii_"+str(i)+".vtk"
    ...
    write_sac_scalar_vtk(outfilename1, 1, "mom1", alldat, modelinfo)
    write_sac_scalar_vtk(outfilename2, 2, "mom2", alldat, modelinfo)
    write_sac_scalar_vtk(outfilename3, 3, "mom3", alldat, modelinfo)
